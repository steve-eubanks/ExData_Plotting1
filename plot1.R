...
# Plot 1 as assigned in Course Project 1 in the class Exploratory Data Analysis
...
#
#Create Plot 1 using the hist() function
#
#First, open a screen device to build the plot and display it on the screen
windows()

# Create the histogram plot
with(subp, hist(Global_active_power, col="red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power"))
